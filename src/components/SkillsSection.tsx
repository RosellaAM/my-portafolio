...
const skillCategories = [
  { title: "Languages", icon: "💻", skills: ["Python", "SQL", "HTTPS"] },
  { title: "ML & AI", icon: "🧠", skills: ["Scikit-learn", "TensorFlow", "PyTorch", "XGBoost"] },
  { title: "Data Tools", icon: "📊", skills: ["Pandas", "NumPy", "SciPy"] },
  { title: "Visualization", icon: "📈", skills: ["Matplotlib", "Plotly", "Seaborn", "PowerBI"] },
  { title: "Deployment", icon: "🚀", skills: ["Git", "Joblib", "Google Drive API"] },
];
      ...
      <div className="container max-w-5xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-5">
          {skillCategories.map((category, i) => (
            ...
            >
              <TiltCard
                className="h-full bg-card/60 backdrop-blur-sm border border-border rounded-xl p-6 hover:border-primary/40 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5"
                intensity={10}
              >
