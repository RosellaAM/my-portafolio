...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-1 px-2 py-2 rounded-full bg-card/70 backdrop-blur-xl border border-border/60 shadow-[0_0_20px_rgba(128,0,32,0.4)] hover:shadow-[0_0_30px_rgba(128,0,32,0.7)] transition-shadow duration-300">
        {navItems.map((item) => (
          <a
            key={item.href}
            href={item.href}
      ...
      <div className="md:hidden">
        <button
          className="flex items-center justify-center w-11 h-11 rounded-full bg-card/70 backdrop-blur-xl border border-border/60 shadow-[0_0_20px_rgba(128,0,32,0.4)] hover:shadow-[0_0_30px_rgba(128,0,32,0.7)] transition-shadow duration-300 text-muted-foreground"
