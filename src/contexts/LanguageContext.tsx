...
const translations: Record<string, Record<Language, string>> = {
  ...
  "project.fashion-retail.description": {
    en: "The Challenge: A multinational fashion retailer with 35 stores across 7 countries needed to understand 4+ million transactions.\n\nWhat I Did: I built an interactive Power BI dashboard that transforms raw transaction data into actionable business intelligence. The dashboard features executive KPIs, customer segmentation, and product performance analysis with filtering.\n\nThe Result: 79.8% repeat purchase rate • $1.56B revenue • 25-34 year olds drive 40% of sales — enabling targeted marketing and smarter inventory decisions.",
    es: "El Desafío: Una empresa multinacional de moda con 35 tiendas en 7 países necesitaba entender más de 4 millones de transacciones.\n\nMi Solución: Construí un dashboard interactivo en Power BI que transforma datos de transacciones en inteligencia de negocio accionable. El dashboard incluye KPIs ejecutivos, segmentación de clientes y análisis de rendimiento de productos con filtros.\n\nEl Resultado: 79.8% de recompra • $1.56B en ingresos • Jóvenes de 25-34 años generan el 40% de las ventas — permitiendo marketing dirigido e inventario más inteligente."
  },
